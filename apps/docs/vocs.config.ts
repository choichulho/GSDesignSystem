...
export default defineConfig({
  ...
  sidebar: {
    ...
    '/components': [
      ...
      { text: 'Navigation', collapsed: false, items: items('components', ['Bottom Navigation', 'Breadcrumbs', 'Navigation Header', 'Page Control', 'Pagination', 'Side Navigation', 'Tabs']) },
      { text: 'Data & Tables', collapsed: false, items: items('components', ['Charts', 'Data Table']) },
      { text: 'Patterns', collapsed: false, items: items('components', ['Loading', 'Modality']) },
    ],
    '/develop': [
