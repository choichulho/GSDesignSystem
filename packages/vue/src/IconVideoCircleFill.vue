<template>
  ...
  >
    <path fill="currentColor" fill-rule="evenodd" d="M18.5 14.609a.75.75 0 0 1-1.233.574l-2.04-1.712v1.12a1.5 1.5 0 0 1-1.5 1.5H8a1.5 1.5 0 0 1-1.5-1.5V9.409A1.5 1.5 0 0 1 8 7.91h5.727a1.5 1.5 0 0 1 1.5 1.5v1.071l2.04-1.712a.75.75 0 0 1 1.233.575zM12 1.999C6.477 2 2 6.478 2 12c0 5.524 4.477 10 10 10s10-4.476 10-10c0-5.522-4.477-10-10-10" clip-rule="evenodd"/>
  </svg>
</template>
