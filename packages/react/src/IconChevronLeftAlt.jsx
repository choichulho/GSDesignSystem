...
export const IconChevronLeftAlt = React.forwardRef(({ size = 24, ...props }, ref) => (
  <svg
    ...
    {...props}
  >
    <path fill="currentColor" fillRule="evenodd" d="M3.5 12c0 4.687 3.813 8.5 8.5 8.5s8.5-3.813 8.5-8.5-3.813-8.5-8.5-8.5S3.5 7.313 3.5 12M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12m10.752-4.782a.75.75 0 0 1 1.06 1.061L10.093 12l3.72 3.72a.751.751 0 0 1-1.061 1.061l-4.247-4.248-.003-.001-.001-.001a.75.75 0 0 1 0-1.062l.002-.001.002-.001z" clipRule="evenodd"/>
  </svg>
));
